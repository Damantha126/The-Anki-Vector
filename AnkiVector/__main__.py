...
PM_START_TEXT = """
𝙃𝙚𝙡𝙡𝙤 𝙩𝙝𝙚𝙧𝙚, 𝙄'𝙢 [ＴＷＩＮＫＬＥ✨](t.me/@TwinkleNub_bot) 
𝙄'𝙢 𝙖 𝙋𝙤𝙬𝙚𝙧𝙛𝙪𝙡 𝙜𝙧𝙤𝙪𝙥 𝙢𝙖𝙣𝙖𝙜𝙚𝙧 𝙗𝙤𝙩 𝙒𝙞𝙩𝙝 𝘾𝙤𝙤𝙡 𝙈𝙤𝙙𝙪𝙡𝙚𝙨. 𝙈𝙖𝙙𝙚 𝙗𝙮 [ ⛣ΔβĦΔ¥ッ♛ (𝙼𝚛.𝙷𝚊𝚗𝚓𝚒 ♛) ⁪⁬](t.me/PARA_TOXIC69)
...
buttons = [
    [
        InlineKeyboardButton(text="📌ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="https://t.me/SNAKEANTlBAN"),
        InlineKeyboardButton(text="🖲 ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="https://t.me/SNAKEANTlBAN"),
    ],
    [
        InlineKeyboardButton(text="👑 ᴏᴡɴᴇʀ", url="https://t.me/PARA_TOXIC69"),
        InlineKeyboardButton(text="❔ ʜᴇʟᴘ", url="http://t.me/TwinkleNub_bot?start=help"),
    ],
    [
        InlineKeyboardButton(
            text="➕ ᴀᴅᴅ ＴＷＩＮＫＬＥ✨ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="t.me/TwinkleNub_bot?startgroup=true"
        ),
    ],
]


ANKIVECTOR_IMG = "https://telegra.ph/file/f8c7c4dc1021ba712818a.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/f8c7c4dc1021ba712818a.jpg)
...
Support them  [⛣ΔβĦΔ¥ッ♛ (𝙼𝚛.𝙷𝚊𝚗𝚓𝚒 ♛)](t.me/PARA_TOXIC69)"""
